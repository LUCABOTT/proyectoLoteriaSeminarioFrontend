    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-zinc-100 mb-2">Activar Cuenta</h1>
          <p className="text-zinc-400">Ingresa el código PIN que se mostró en la consola</p>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 p-8">
          {error && (
            <div className="bg-red-500/10 border border-red-500/20 text-red-400 px-4 py-3 mb-6 text-sm">{error}</div>
          )}
          ...
          <form onSubmit={handleConfirm} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-zinc-500">Revisa la consola del navegador (F12) para encontrar tu PIN</p>
            </div>
