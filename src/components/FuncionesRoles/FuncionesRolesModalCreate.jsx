...
export default function FuncionesRolesModalCreate({ isOpen, onClose, onSaved }) {
  ...
  async function handleGuardar() {
    ...
    setError(null);
    try {
      await funcionesRolesService.crear(form);
      onSaved();
      onClose();
    } catch (err) {
  ...
  return (
    <Modal isOpen={isOpen}>
      <ModalHeader onClose={onClose}>Nueva Función-Rol</ModalHeader>
      <ModalBody>
      ...
      <ModalFooter>
        ...
        <Button variant="primary" isLoading={loading} onClick={handleGuardar}>Guardar</Button>
      </ModalFooter>
    </Modal>
  );
}
